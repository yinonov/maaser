    ...
    <main className="flex min-h-screen flex-col items-center justify-center p-24 bg-gradient-to-br from-primary/10 to-secondary/10">
      <div className="z-10 max-w-5xl w-full items-center justify-center font-mono text-sm">
        <div className="text-center">
          <h1 className="text-6xl font-bold mb-4 text-primary">HaMaaser</h1>
          <p className="text-2xl mb-8 text-gray-600">Digital Tithing Platform - Dashboard</p>
          ...
          <div className="mt-12 space-y-4">
            <p className="text-sm text-gray-500">🚀 Phase 2 Foundation Complete</p>
